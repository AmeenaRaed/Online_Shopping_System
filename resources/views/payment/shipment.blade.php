    ...
    $receipt = session('receipt');
        ...
        <div class="alert" style="background-color:--muted-rose;">
            ...
            <p><strong>Discount Code:</strong>
                <?php    echo !empty($receipt['discount_code']) ? htmlspecialchars($receipt['discount_code']) : 'N/A'; ?>
            </p>
       ...
       ?>
        ...
        <form method="POST" action=" {{route('shipment.process', $order)}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="recipient_name" id="recipient_name" placeholder="Enter the recipient's name"
                    required value="<?php echo old('recipient_name'); ?>">
            </div>

            <div class="form-group">
                <label for="contact_number">Contact Number</label>
                <input type="text" name="contact_number" id="contact_number" placeholder="+973 00000000" required
                    value="<?php echo old('contact_number'); ?>" pattern="[0-9]{8}" minlength="8" maxlength="8"
            ...
            <div class="form-group">
                ...
                <input type="text" name="street" id="street" placeholder="Enter street name" required
                    value="<?php echo old('street'); ?>" pattern="^(?=.{3,})[A-Za-z0-9\s]+$"
            ...
            <div class="form-group">
                ...
                <input type="text" name="road" id="road" placeholder="Enter road name" required
                    value="<?php echo old('road'); ?>" pattern="^(?=.{3,})[A-Za-z0-9\s]+$"
            ...
            <div class="form-group">
                ...
                <input type="text" name="house_number" id="house_number" placeholder="Enter house number" required
                    value="<?php echo old('house_number'); ?>" pattern="^(?=.{1,10}$)\d+[A-Za-z]*$"
            ...
            <div class="form-group">
                ...
                <select name="country" id="country" required>
                    ...
                    <option value="Muharraq" <?php echo old('country') == 'Muharraq' ? 'selected' : ''; ?>>Muharraq
                    </option>
                    <option value="Riffa" <?php echo old('country') == 'Riffa' ? 'selected' : ''; ?>>Riffa</option>
                    <option value="Isa Town" <?php echo old('country') == 'Isa Town' ? 'selected' : ''; ?>>Isa Town
                    </option>
