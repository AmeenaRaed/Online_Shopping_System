    ...
    <div class="flex h-screen w-screen">
            ...
            <div class="flex justify-between items-center p-4 bg-black rounded-lg shadow-md">
                ...
                <div class="flex items-center gap-2">
                    <input id="searchInput" type="text" placeholder="Search users..."
                        class="p-2 border border-black bg-white rounded-md text-center">

                    <select id="roleFilter"
                        class="p-2 border border-black bg-white text-gray-500 rounded-md text-center">
                                ...
                                <tr class="border-t text-center">
                                    ...
                                    <td class="p-3">
                                        ...
                                        <button onclick="confirmDeleteUser('{{ $user->id }}', '{{ $user->name }}')"
                                            class="text-red-500 hover:text-red-700 ml-2 rounded">Delete</button>
                                        <button onclick="viewUserDetails({{ $user->id }})"
                                            class="text-blue-500 hover:text-blue-700 ml-2 rounded">View</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-[40rem]">
                ...
                <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <textarea name="address" placeholder="Address"
                        class="w-full p-2 border border-gray-300 rounded-md mt-4"></textarea>
        ...
        <div id="deleteUserModal"
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-[30rem]">
                ...
                <p class="text-gray-800">Are you sure you want to delete <strong id="modalUserName"></strong>? This
                ...
                <form id="editUserForm" method="POST" action="{{ route('admin.users.update', $user->id) }}">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <input type="text" name="last_name" id="editLastName" placeholder="Last Name"
                            class="p-2 border border-gray-300 rounded-md" required>
                        <input type="date" name="dob" id="editDOB" placeholder="Date of Birth"
                            class="p-2 border border-gray-300 rounded-md" required>
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <button type="submit" id="editUserSubmit"
