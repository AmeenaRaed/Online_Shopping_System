        ...
        <div class="flex justify-center relative mb-10">
            <div x-data="{
                ...
                <template x-for="(slide, index) in slides" :key="index">
                    <div x-show="true" x-transition:enter="transition-opacity duration-1000 ease-in-out"
                        ...
                        <!-- Gradient Overlay -->
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-muted-rose via-soft-lilac to-dusky-blue opacity-70">
                        </div>

                        <!-- Content -->
                        <div
                            class="relative z-30 flex flex-col items-center justify-center h-full text-white text-center px-6">
                            <h1 class="text-3xl md:text-5xl font-extrabold mb-4 drop-shadow-lg" x-text="slide.title">
                            </h1>
